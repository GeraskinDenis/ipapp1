...
//Местонахождение
public class R_location extends EntityDecorator {

	private static final String TABLE_NAME = "r_location";

	public R_location() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public R_location(EntityDTO record) {
		if (record == null)
	...
	public String get_Location_type() {
		return record.getAsString("location_type");
	}

	//Родительское местонахождение
	public Long get_Parent_location() {
		return record.getAsLong("parent_location");
	}

	//ID
	public Long get_R_locationid() {
		return record.getAsLong("r_locationid");
	}
	...
	//Тип местоположения
	public void set_Location_type(String fieldValue) {
		record.set("location_type", fieldValue);
	}

	//Родительское местонахождение
	public void set_Parent_location(Long fieldValue) {
		record.set("parent_location", fieldValue);
	}

	//ID
	public void set_R_locationid(Long fieldValue) {
		record.set("r_locationid", fieldValue);
	}
