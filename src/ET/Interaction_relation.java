...
//Связи обращений
public class Interaction_relation extends EntityDecorator {

	private static final String TABLE_NAME = "interaction_relation";

	public Interaction_relation() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Interaction_relation(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Interaction_relationid() {
		return record.getAsLong("interaction_relationid");
	}
	...
	//Зависимое обращение
	public Long get_Related_interaction() {
		return record.getAsLong("related_interaction");
	}
	...
	//ID
	public void set_Interaction_relationid(Long fieldValue) {
		record.set("interaction_relationid", fieldValue);
	}
	...
	//Зависимое обращение
	public void set_Related_interaction(Long fieldValue) {
		record.set("related_interaction", fieldValue);
	}
