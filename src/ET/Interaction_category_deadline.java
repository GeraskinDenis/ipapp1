...
//Срок выполнения по категории
public class Interaction_category_deadline extends EntityDecorator {

	private static final String TABLE_NAME = "interaction_category_deadline";

	public Interaction_category_deadline() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Interaction_category_deadline(EntityDTO record) {
		if (record == null)
	...
	public Long get_Duration() {
		return record.getAsLong("duration");
	}

	//ID
	public Long get_Interaction_category_deadlineid() {
		return record.getAsLong("interaction_category_deadlineid");
	}
	...
	//Длительность, часов
	public void set_Duration(Long fieldValue) {
		record.set("duration", fieldValue);
	}

	//ID
	public void set_Interaction_category_deadlineid(Long fieldValue) {
		record.set("interaction_category_deadlineid", fieldValue);
	}
