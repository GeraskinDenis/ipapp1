...
//Рабочее место
public class Workplace extends EntityDecorator {
	...
	public Workplace(EntityDTO record) {
		if (record == null)
	...
	//Здание
	public Long get_Building() {
		return record.getAsLong("building");
	}
	...
	//ID
	public Long get_Workplaceid() {
		return record.getAsLong("workplaceid");
	}

	//Рабочее пространство
	public String get_Workspace() {
		return record.getAsString("workspace");
	}
	...
	//Здание
	public void set_Building(Long fieldValue) {
		record.set("building", fieldValue);
	}
	...
	//ID
	public void set_Workplaceid(Long fieldValue) {
		record.set("workplaceid", fieldValue);
	}

	//Рабочее пространство
	public void set_Workspace(String fieldValue) {
