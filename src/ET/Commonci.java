...
//КЕ (общая)
public class Commonci extends EntityDecorator {

	private static final String TABLE_NAME = "commonci";

	public Commonci() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Commonci(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Commonciid() {
		return record.getAsLong("commonciid");
	}
	...
	//ID
	public void set_Commonciid(Long fieldValue) {
		record.set("commonciid", fieldValue);
	}
