...
//Категория работы
public class Plannedactivity_category extends EntityDecorator {

	private static final String TABLE_NAME = "plannedactivity_category";

	public Plannedactivity_category() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Plannedactivity_category(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Plannedactivity_categoryid() {
		return record.getAsLong("plannedactivity_categoryid");
	}
	...
	//ID
	public void set_Plannedactivity_categoryid(Long fieldValue) {
		record.set("plannedactivity_categoryid", fieldValue);
	}
