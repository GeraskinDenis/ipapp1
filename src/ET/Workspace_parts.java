...
//Комплектующие для рабочего места
public class Workspace_parts extends EntityDecorator {

	private static final String TABLE_NAME = "workspace_parts";

	public Workspace_parts() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Workspace_parts(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Workspace_partsid() {
		return record.getAsLong("workspace_partsid");
	}
	...
	//ID
	public void set_Workspace_partsid(Long fieldValue) {
		record.set("workspace_partsid", fieldValue);
	}
