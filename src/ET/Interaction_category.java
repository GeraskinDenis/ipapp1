...
//Категория обращения
public class Interaction_category extends EntityDecorator {

	private static final String TABLE_NAME = "interaction_category";

	public Interaction_category() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Interaction_category(EntityDTO record) {
		if (record == null)
	...
	//Порядок отображения
	public Long get_Category_order() {
		return record.getAsLong("category_order");
	}
	...
	//ID
	public Long get_Interaction_categoryid() {
		return record.getAsLong("interaction_categoryid");
	}
	...
	//Порядок отображения
	public void set_Category_order(Long fieldValue) {
		record.set("category_order", fieldValue);
	}
	...
	//ID
	public void set_Interaction_categoryid(Long fieldValue) {
		record.set("interaction_categoryid", fieldValue);
	}
