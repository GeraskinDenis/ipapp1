...
//Шаблон КЕ
public class Citemplate extends EntityDecorator {

	private static final String TABLE_NAME = "citemplate";

	public Citemplate() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Citemplate(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Citemplateid() {
		return record.getAsLong("citemplateid");
	}
	...
	//ID
	public void set_Citemplateid(Long fieldValue) {
		record.set("citemplateid", fieldValue);
	}
