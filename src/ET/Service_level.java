...
//Уровень сервиса
public class Service_level extends EntityDecorator {

	private static final String TABLE_NAME = "service_level";

	public Service_level() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Service_level(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Service_levelid() {
		return record.getAsLong("service_levelid");
	}
	...
	//ID
	public void set_Service_levelid(Long fieldValue) {
		record.set("service_levelid", fieldValue);
	}
