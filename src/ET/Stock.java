...
//Склад
public class Stock extends EntityDecorator {
	...
	//ID
	public Long get_Stockid() {
		return record.getAsLong("stockid");
	}
	...
	//ID
	public void set_Stockid(Long fieldValue) {
		record.set("stockid", fieldValue);
	}
