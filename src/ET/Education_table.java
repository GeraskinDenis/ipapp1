...
//education_table
public class Education_table extends EntityDecorator {

	private static final String TABLE_NAME = "education_table";

	public Education_table() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Education_table(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Education_tableid() {
		return record.getAsLong("education_tableid");
	}
	...
	//ID
	public void set_Education_tableid(Long fieldValue) {
		record.set("education_tableid", fieldValue);
	}
