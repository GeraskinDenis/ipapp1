...
//ТНК операции
public class Activity_norm_relation extends EntityDecorator {

	private static final String TABLE_NAME = "activity_norm_relation";

	public Activity_norm_relation() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Activity_norm_relation(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Activity_norm_relationid() {
		return record.getAsLong("activity_norm_relationid");
	}
	...
	//ТНК
	public Long get_Norm() {
		return record.getAsLong("norm");
	}
	...
	public Double get_Volume() {
		return record.getAsDouble("volume");
	}

	//ID
	public void set_Activity_norm_relationid(Long fieldValue) {
		record.set("activity_norm_relationid", fieldValue);
	}
	...
	//ТНК
	public void set_Norm(Long fieldValue) {
		record.set("norm", fieldValue);
	}
	...
	//Объем ТНК
	public void set_Volume(Double fieldValue) {
		record.set("volume", fieldValue);
	}
