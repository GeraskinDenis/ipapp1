...
//Картридж
public class Cartridge extends EntityDecorator {

	private static final String TABLE_NAME = "cartridge";

	public Cartridge() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Cartridge(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Cartridgeid() {
		return record.getAsLong("cartridgeid");
	}
	...
	//Принтер
	public Long get_Printer() {
		return record.getAsLong("printer");
	}
	...
	//ID
	public void set_Cartridgeid(Long fieldValue) {
		record.set("cartridgeid", fieldValue);
	}
	...
	//Принтер
	public void set_Printer(Long fieldValue) {
		record.set("printer", fieldValue);
	}
