...
//Учебная Таблица ТипаКЕ
public class Studycitypetable extends EntityDecorator {

	private static final String TABLE_NAME = "studycitypetable";

	public Studycitypetable() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Studycitypetable(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Studycitypetableid() {
		return record.getAsLong("studycitypetableid");
	}
	...
	//ID
	public void set_Studycitypetableid(Long fieldValue) {
		record.set("studycitypetableid", fieldValue);
	}
