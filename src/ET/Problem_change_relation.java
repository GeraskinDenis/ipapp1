...
//Связь проблем и изменений
public class Problem_change_relation extends EntityDecorator {

	private static final String TABLE_NAME = "problem_change_relation";

	public Problem_change_relation() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Problem_change_relation(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Problem_change_relationid() {
		return record.getAsLong("problem_change_relationid");
	}
	...
	//ID
	public void set_Problem_change_relationid(Long fieldValue) {
		record.set("problem_change_relationid", fieldValue);
	}
