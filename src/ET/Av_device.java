...
public class Av_device extends EntityDecorator {

	private static final String TABLE_NAME = "av_device";

	public Av_device() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Av_device(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Av_deviceid() {
		return record.getAsLong("av_deviceid");
	}
	...
	//ID
	public void set_Av_deviceid(Long fieldValue) {
		record.set("av_deviceid", fieldValue);
	}
