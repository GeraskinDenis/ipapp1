...
//Компьютер
public class Computer extends EntityDecorator {
	...
	public Computer(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Computerid() {
		return record.getAsLong("computerid");
	}
	...
	//ID
	public void set_Computerid(Long fieldValue) {
		record.set("computerid", fieldValue);
	}
