...
//Сотрудники РГ
public class Workgroup_user extends EntityDecorator {

	private static final String TABLE_NAME = "workgroup_user";

	public Workgroup_user() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Workgroup_user(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Workgroup_userid() {
		return record.getAsLong("workgroup_userid");
	}
	...
	//ID
	public void set_Workgroup_userid(Long fieldValue) {
		record.set("workgroup_userid", fieldValue);
	}
