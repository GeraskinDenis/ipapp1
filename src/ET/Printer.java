...
//Принтер
public class Printer extends EntityDecorator {
	...
	public Printer(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Printerid() {
		return record.getAsLong("printerid");
	}
	...
	//ID
	public void set_Printerid(Long fieldValue) {
		record.set("printerid", fieldValue);
	}
