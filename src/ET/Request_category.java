...
//Категория запроса
public class Request_category extends EntityDecorator {

	private static final String TABLE_NAME = "request_category";

	public Request_category() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Request_category(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Request_categoryid() {
		return record.getAsLong("request_categoryid");
	}
	...
	//ID
	public void set_Request_categoryid(Long fieldValue) {
		record.set("request_categoryid", fieldValue);
	}
