...
//Тип документа
public class Document_type extends EntityDecorator {

	private static final String TABLE_NAME = "document_type";

	public Document_type() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Document_type(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Document_typeid() {
		return record.getAsLong("document_typeid");
	}
	...
	//ID
	public void set_Document_typeid(Long fieldValue) {
		record.set("document_typeid", fieldValue);
	}
