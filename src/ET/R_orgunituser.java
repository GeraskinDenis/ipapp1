...
//Сотрудник - Орг. единица
public class R_orgunituser extends EntityDecorator {

	private static final String TABLE_NAME = "r_orgunituser";

	public R_orgunituser() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public R_orgunituser(EntityDTO record) {
		if (record == null)
	...
	public Boolean get_Ismain() {
		return record.getAsBoolean("ismain");
	}
	...
	//Внутренний код
	public Long get_R_orgunituserid() {
		return record.getAsLong("r_orgunituserid");
	}
	...
	//Основная организационная единица
	public void set_Ismain(Boolean fieldValue) {
		record.set("ismain", fieldValue);
	}
	...
	//Внутренний код
	public void set_R_orgunituserid(Long fieldValue) {
		record.set("r_orgunituserid", fieldValue);
	}
	...
	//Пользователь
	public void set_User(Long fieldValue) {
		record.set("user", fieldValue);
	}
