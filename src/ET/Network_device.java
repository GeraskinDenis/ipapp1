...
public class Network_device extends EntityDecorator {

	private static final String TABLE_NAME = "network_device";

	public Network_device() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Network_device(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Network_deviceid() {
		return record.getAsLong("network_deviceid");
	}
	...
	//ID
	public void set_Network_deviceid(Long fieldValue) {
		record.set("network_deviceid", fieldValue);
	}
