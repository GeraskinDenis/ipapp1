...
//Подсеть
public class Subnetwork extends EntityDecorator {

	private static final String TABLE_NAME = "subnetwork";

	public Subnetwork() {
		this.record = new EntityDTO(TABLE_NAME);
	}

	public Subnetwork(EntityDTO record) {
		if (record == null)
	...
	//ID
	public Long get_Subnetworkid() {
		return record.getAsLong("subnetworkid");
	}
	...
	//ID
	public void set_Subnetworkid(Long fieldValue) {
		record.set("subnetworkid", fieldValue);
	}
