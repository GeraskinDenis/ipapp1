...
DisplayName: Услуга
Fields:
 - calendar (Календарь доступности услуги) - INTEGER
 - citype (Тип КЕ - число) - INTEGER
 - citype_shortname (Типовая услуга) - STRING
 - consumer_count (Количество потребителей) - INTEGER
 ...
 - link_to_rsm (Ссылка на РСМ) - TEXT
 - location (Рабочее пространство) - INTEGER
 - logicalname (Код поиска) - STRING
 - model (Модель) - INTEGER
 - owner (Менеджер услуги) - INTEGER
 - serviceid (ID) - INTEGER
 - shortname (Внутреннее имя) - STRING
 - startdate (Дата ввода в эксплуатацию) - DATE
 - subnetwork (Подсеть) - INTEGER
 - systems (Информационные системы) - INTEGER
 - unnumber (Код услуги) - STRING
