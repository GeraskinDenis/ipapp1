...
/**
DisplayName: Информационная система
Fields:
 ...
 - domain_name (Доменное имя) - STRING, вычисление: concat('http://178.154.206.31:8080/#/informationsystem/', informationsystemid)
 - informationsystemid (ID) - INTEGER
 ...
 - model (Модель) - STRING
 - related_documentation (Документация) - INTEGER
...
public class informationsystem_Rules {
